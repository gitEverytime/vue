...
<script>
    ...
    import TempUnSettlementTable   from './unsettlement_table.vue'
    ...
    export default {
        ...
        watch:{
            setIsSettle(val){
                if(val) this.reqFinanceSettleList();
            }
        },
        computed:{
            curInfo(){
            ...
            //判断结账单结账完成是否更新list
            setIsSettle(){
                return this.$store.getters.getIsSettle;
            }
        },
        created(){
            this.getCurInfo();
            ...
            reqFinanceSettleList(){
                ...
                REQ.reqFinanceSettleList(postData,
                    (result) => {
                        ...
                        vm.$store.commit('setIsSettle',false);
                        //存贮记录
                        let oData = {
                            ac1: vm.oCode.ac1,
                            ac2: vm.oCode.ac2,
